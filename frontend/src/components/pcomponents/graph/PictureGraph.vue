<template>
  ...
  <svg id="svg" width="210" height="210" xmlns="http://www.w3.org/2000/svg" @click="$emit('clickOnSVG')">
    <template v-if="param_r > 0 ">
      <polygon points="100,100 100,20 60,100" class="svg-figure-color" stroke-width="2"></polygon>
      <polygon points="100,180 60,180 60,100 100,100" class="svg-figure-color" stroke-width="2"></polygon>
      <path d="M100,100 h40 a40,40 0 0,0 -40,-40z" class="svg-figure-color" stroke-width="2"></path>
    </template>
  <template v-if="param_r < 0 ">
    <polygon points="100,100 100,180 140,100" class="svg-figure-color" stroke-width="2"></polygon>
    <polygon points="100,20 140,20 140,100 100,100" class="svg-figure-color" stroke-width="2"></polygon>
    <path d="M100,100 h-40 a40,40 0 0,0 40,40z" class="svg-figure-color" stroke-width="2"></path>
  </template>
      <line x1="100" y1="0" x2="100" y2="200" stroke-width="0"
    ...
    <line x1="200" y1="100" x2="190" y2=95 stroke-width="2"
          class="svg-line-color"></line>
    <text x="30" y="92" class="svg-text">{{-param_r/2}}</text>
    <text x="6" y="92" class="svg-text">{{-param_r}}</text>
    <text x="107" y="30" class="svg-text">{{param_r}}</text>
    <text x="107" y="70" class="svg-text">{{param_r/2}}</text>
    <text x="110" y="10" class="svg-text">y</text>
    <text x="130" y="92" class="svg-text">{{param_r/2}}</text>
    <text x="170" y="92" class="svg-text">{{param_r}}</text>
    <text x="190" y="92" class="svg-text">x</text>
    <text x="107" y="140" class="svg-text">{{-param_r/2}}</text>
    <text x="107" y="180" class="svg-text">{{-param_r}}</text>
  </svg>
</template>
